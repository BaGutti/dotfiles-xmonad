...
-- myWorkspaces	= ["WWW", "Term", "Game", "Chat", "Mail", "Play","File","Conf","Sys"]
...
myKeys conf@(XConfig {XMonad.modMask = modm}) = M.fromList $
    ...
    , ((modm .|. shiftMask, xK_g), sendMessage $ setGaps [(L,05), (R,05), (U,45), (D,45)]) -- reset the GapSpec
...
defaults = def {
      ...
      -- hooks, layouts
        ...
        layoutHook = gaps [(L,05), (R,05), (U,45), (D,45)] $ spacingRaw True (Border 10 10 10 10) True (Border 10 10 10 10) True $ smartBorders $ myLayout,
